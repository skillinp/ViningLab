...
# Each of those bam files is quite large, so downloading them all to a local machine from the Oregon State University infrastructure 
# would take a lot of resources as well as a lot of time.
# The bam files contain many sections, in this case, the sections are contigs named things like "000049F|arrow" or "000068F|arrow".
# They might in other cases be chromosomes like "Chromosome 1".
