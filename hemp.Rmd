...
```{r, fig.width = 8, fig.height=6, fig.align='center', fig.cap="Figure X. Idiogram of the nine autosomal chromosomes and a sex chromosome (CBDRx was genetically female so it was homozygous for the X chromosome)."}
